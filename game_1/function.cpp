...
vector<vector<int>> VALID_DIR({{-1, -1, 1}, {-1, 0, 2}, {-1, 1, 3}, {0, -1, 4}, {0, 1, 6}, {1, -1, 7}, {1, 0, 8}, {1, 1, 9}});
map<int, vector<int>> action_map({{1, {-1,-1}}, {2, {-1,0}}, {3, {-1,1}}, {4, {0,-1}}, {6, {0,1}}, {7, {1,-1}}, {8, {1,0}}, {9, {1,1}}});
